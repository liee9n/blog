...
document.addEventListener("DOMContentLoaded", function() {
    const button = document.querySelector('a.excerpt_more.button');
    if (button) {
        button.style.backgroundColor = "#007bff"; // New background color
        button.style.color = "white"; // Text color
        button.style.padding = "10px 20px"; // Add padding
        button.style.borderRadius = "5px"; // Round corners
